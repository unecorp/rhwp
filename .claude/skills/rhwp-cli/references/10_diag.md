...
권위: `mydocs/manual/cli_commands.md` 의 `diag` 절, `src/main.rs` 디스패치.
...
```bash
rhwp diag samples/basic/KTX.hwp
```
...
관련: [00_tree.md](00_tree.md) · [01_request_command_map.md](01_request_command_map.md) · 장 10

## 호출 카드

| 상황 | 명령 | 읽는 것 |
|---|---|---|
| 없는 경로 | `rhwp diag 없는파일.hwp` | exit 1, missing-file |
| 인자 없음 | `rhwp diag` | exit 2, no-input (인자가 필수인 명령) |
| 한컴 4쪽 | `rhwp diag doc.hwp -s 0 -p 3` | 0 기준 |
