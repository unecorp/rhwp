...
명령: `rhwp hwp5-anchor-trace generated.hwp --needle "별표" --section 0`

이 예제는 기존 `hwp5-anchor-trace` 만 쓴다. 새 CLI 없음. gym 없음.

## 언제

사용자가 "needle" 에 해당하는 말을 할 때. 페이지가 있으면 0 기준인지 확인한다.

## 절차

```bash
cargo build --release
rhwp hwp5-anchor-trace generated.hwp --needle "별표" --section 0
```
