...
명령: `rhwp hwp5-inventory-diff oracle.hwp generated.hwp --report hints --focus table`

이 예제는 기존 `hwp5-inventory-diff` 만 쓴다. 새 CLI 없음. gym 없음.

## 언제

사용자가 "oracle 비교" 에 해당하는 말을 할 때. 페이지가 있으면 0 기준인지 확인한다.
