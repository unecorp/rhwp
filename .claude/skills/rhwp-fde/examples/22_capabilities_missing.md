...
```bash
python3 tools/fde/triage.py 고객문서 --bin rhwp --symptom '자기서술 실패' -o ticket.json
```
...
관련: `references/24_worked_traces.md`, `fixtures/traces/T02.json`.
