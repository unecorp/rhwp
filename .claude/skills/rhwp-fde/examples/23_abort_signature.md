...
```bash
python3 tools/fde/triage.py 고객문서 --bin rhwp --symptom 'abort' -o ticket.json
```

기대 라우트 계열: **escalate-crash**.
...
관련: `references/24_worked_traces.md`, `fixtures/traces/T05.json`.
