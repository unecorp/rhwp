...
```bash
python3 tools/fde/triage.py 고객문서 --bin rhwp --symptom '필드 미채움' -o ticket.json
```

기대 라우트 계열: **resolve-now → form-fill**.
...
관련: `references/24_worked_traces.md`, `fixtures/traces/T09.json`.
