...
```bash
python3 tools/fde/triage.py 고객문서 --bin rhwp --symptom '암호' -o ticket.json
```

기대 라우트 계열: **resolve-now + 암호 요청**.
...
관련: `references/24_worked_traces.md`, `fixtures/traces/T06.json`.
