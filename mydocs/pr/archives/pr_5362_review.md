...
# PR #5362 검토 - oracle_public coverage_report

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5362](https://github.com/edwardkim/rhwp/pull/5362) / kevin9327 |
| base / contributor head | devel / 68f04f0f91c5416d9748ba1c2c40fbfb1d70ef09 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | bbe03e4e983d86ce476860ba7a90c6288aa4c3f8 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

짝 없는 샘플과 Hancom 버전별 coverage 표를 추가했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5362까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: 없음
- 보정: pair·sample·version count를 새 manifest에 맞춰 정합화했다.
- 공통 통합 정리 commit: 5b9599ffb98c5dcc72c0e73937df076ea1e77031
- 공통 정합화 commit: 5f0d7e0a8482617747bdc7d7df57e98e6717a02c

## 검증

- focused: tools.oracle_public.test_coverage_report, tools.oracle_public.tests.test_oracle_resolver
