...
# PR #5084 검토 - edit set-column-widths 표 열 폭 설정

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5084](https://github.com/edwardkim/rhwp/pull/5084) |
| 작성자 | @kevin9327 |
| 원 source head | `24d49b50ba78` |
...
정합화했다. 표 열 폭 설정 기능과 HWPUNIT 계약을 반영했다.
