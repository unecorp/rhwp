...
# PR #5272 검토 - gym release_gate 예외 경로

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5272](https://github.com/edwardkim/rhwp/pull/5272) / kevin9327 |
| base / contributor head | devel / 7084730b758abfbe25966569ff8a553efa873414 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 97705f5d5bfc61a6318cf68622893bfcf61ce1a9 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

release gate 예외 경로와 판정 정직성 시험을 보강했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5272까지의 의존 순서를 따랐다.
...
- focused: scripts.tests.test_gym_release_gate_exceptions, scripts.tests.test_gym_release_gate_workflow
