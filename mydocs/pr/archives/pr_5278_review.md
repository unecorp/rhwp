...
# PR #5278 검토 - gym score/runner 채점기

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5278](https://github.com/edwardkim/rhwp/pull/5278) / kevin9327 |
| base / contributor head | devel / 2ccfd59a9bed92670e750746b0b8d5724751b134 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | a5efcb2a636939b28972ac4f8a79955f04da1da9 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

score·runner 예외 경로, 문서와 시험을 강화했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5278까지의 의존 순서를 따랐다.
...
- focused: scripts.tests.test_gym_score, scripts.tests.test_gym_score_runner
