# PR #5431 검토 - docs(fuzz): OSS-Fuzz 온보딩 계획 — M10-1
...
- 원 PR: [5431](https://github.com/edwardkim/rhwp/pull/5431)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `40d75becd2b6487bdc38d18da8a08d3fa19262c6`

## 체리픽 범위

- 통합 branch 체리픽 commit: `376c01d504ca4c2f554912b01579449738465a83`
