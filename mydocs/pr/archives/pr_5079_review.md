...
# PR #5079 검토 - edit merge-paragraph-in-cell 표 셀 문단 병합

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5079](https://github.com/edwardkim/rhwp/pull/5079) |
| 작성자 | @kevin9327 |
| 원 source head | `7c07d1005bdd` |
...
정합화했다. 표 셀 문단 병합 기능과 좌표 계약을 반영했다.
