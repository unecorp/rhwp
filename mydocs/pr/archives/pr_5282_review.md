...
# PR #5282 검토 - gym build_baseline 자리표와 실패 보고

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5282](https://github.com/edwardkim/rhwp/pull/5282) / kevin9327 |
| base / contributor head | devel / ae34764800feb4e384bf8e3a39130d82b7d18872 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 3d86b5309b544f4aec97e6c978dcef4d9253fb7c |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

자리표 치환, 부재 산출과 실패 보고를 고도화했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5282까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: 없음
- 보정: 불필요한 mydocs/pr_body_draft_5273.md를 제거했다.
- 공통 통합 정리 commit: 5b9599ffb98c5dcc72c0e73937df076ea1e77031
- 공통 정합화 commit: 5f0d7e0a8482617747bdc7d7df57e98e6717a02c

## 검증

- focused: scripts.tests.test_gym_build_baseline
