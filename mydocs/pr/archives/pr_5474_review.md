# PR #5474 검토 - test: render_backend 계약 카탈로그·픽스처 고도화 (M06-f)
...
- 원 PR: [5474](https://github.com/edwardkim/rhwp/pull/5474)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `4aca6ce9fe1b9681a05c3c6d702fa089dffb88e8`

## 체리픽 범위

- 통합 branch 체리픽 commit: `b19e0ff79fd8e7cea7a2db159f3c5358a0e66331`
