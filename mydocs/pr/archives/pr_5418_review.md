# PR #5418 검토 - fix(render): CanvasKit showControlCodes [표]/[그림] 폴백 해제 (M07-2)
...
- 원 PR: [5418](https://github.com/edwardkim/rhwp/pull/5418)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `88e67f82a29e710cab30163a5098d568b8a6b046`

## 체리픽 범위

- 통합 branch 체리픽 commit: `c9c2e393d9de44103a555db2f976c6cb2a61054d`
