# PR #5499 검토 - feat(table): M-tbl 표 CSV 왕복 치수·병합 픽스처
...
- 원 PR: [5499](https://github.com/edwardkim/rhwp/pull/5499)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `dbe22c7ef56ac56340dbfe090c8c6953c2c8aa8e`

## 체리픽 범위

- 통합 branch 체리픽 commit: `aa2d27dc5d19a558105a5e89c8e1cb88f2f8ebfa`
