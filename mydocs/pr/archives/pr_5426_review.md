# PR #5426 검토 - fix(render): CanvasKit verticalText tab-leader/decoration 폴백 해제 (M07-3)
...
- 원 PR: [5426](https://github.com/edwardkim/rhwp/pull/5426)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `8dc75276450cbb50c95c81868a388fe46909adfe`

## 체리픽 범위

- 통합 branch 체리픽 commit: `3c28b5d6b3a70d8a3c1a4c5a24ebb33eebbd3adc`
