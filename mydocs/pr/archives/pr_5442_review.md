# PR #5442 검토 - fix(hwpx): hp:pic offset 을 pos 유래로 재작성하지 않는다 (#4668)
...
- 원 PR: [5442](https://github.com/edwardkim/rhwp/pull/5442)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `45ed77d8e6ab741f676b5e3ab5ae1050c68d454e`

## 체리픽 범위

- 통합 branch 체리픽 commit: `e73790382f206f7993db605f70b3e716d8196c26`
