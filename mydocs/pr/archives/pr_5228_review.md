...
# PR #5228 검토 - gym differential 순수 시험과 관문

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5228](https://github.com/edwardkim/rhwp/pull/5228) / kevin9327 |
| base / contributor head | devel / 304cdcd433619cd8364f830a9ed8d35d4e3eaf1e |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 9d3f1a7eb0a91aa33822d58de01f686481c4677d, 8a9ca3dd723140cbb4bb85df3b326f96b31e37f1 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

differential 순수 시험, 보고와 예외·관문 정직성 시험을 보강했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5228까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: .github/workflows/ci.yml에서 oracle probe와 differential 배선을 함께 보존했다.
- 보정: 기능 범위 밖 보정 없음.
...
- focused: scripts.tests.test_gym_differential
