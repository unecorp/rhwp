...
# PR #5315 검토 - 배포 전 보안 스윕 스킬

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5315](https://github.com/edwardkim/rhwp/pull/5315) / kevin9327 |
| base / contributor head | devel / 23b64c08f1870e6986219b35074d8fd63c0af467 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 881789af84709a528b20e8d6f8ceb7a52e78ee24 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

수신·송신 보안 스윕 스킬, envelope fixture, reference와 계약 시험을 추가했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5315까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: 없음
- 보정: 전화번호 reason 길이, 18개 예제 명령의 rhwp 접두어, 수신 순서 검사 범위를 보정했다.
- 공통 통합 정리 commit: 5b9599ffb98c5dcc72c0e73937df076ea1e77031
- 공통 정합화 commit: 5f0d7e0a8482617747bdc7d7df57e98e6717a02c

## 검증

- focused: agent_security_sweep_envelopes 5/5; gate 4/4; no_raw 6/6; pii_rules 4/4; receive 5/5; skill_contract 6/6
