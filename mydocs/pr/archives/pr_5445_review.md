# PR #5445 검토 - fix(hwpx): hwp3-sample11 HWPX 왕복 쪽수 151 유지 (#3737)
...
- 원 PR: [5445](https://github.com/edwardkim/rhwp/pull/5445)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `1ece727d6b0f5a81ade02629a77e3f467a7d1448`

## 체리픽 범위

- 통합 branch 체리픽 commit: `cc9d7addc9add61d66a7761b86dde78c40bd4e65`
