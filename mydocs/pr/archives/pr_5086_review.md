...
# PR #5086 검토 - edit set-column-def 구역 단 정의

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5086](https://github.com/edwardkim/rhwp/pull/5086) |
| 작성자 | @kevin9327 |
| 원 source head | `a8827d1b6b8c` |
...
정합화했다. 구역 단 정의 CLI/MCP 배선과 단 수·간격 계약을 반영했다.
