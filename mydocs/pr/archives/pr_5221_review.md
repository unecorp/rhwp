...
# PR #5221 검토 - gym 손상-강건성 감사의 결정적 변형

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5221](https://github.com/edwardkim/rhwp/pull/5221) / kevin9327 |
| base / contributor head | devel / 7764dd2b287ddfa50db07af2b48d11a3853a50bf |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 651b8fb58e8a56ce4e1b500dcb95d928662d7212, c2ea033e6f170b12b1c02882b73e55eb11cb5197 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

손상 변형과 예외 경로를 결정적으로 확장했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5221까지의 의존 순서를 따랐다.
...
- focused: scripts.tests.test_gym_robustness
