...
# PR #5137 검토 - edit apply-para-format-in-cell 표 셀 문단 서식

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5137](https://github.com/edwardkim/rhwp/pull/5137) |
| 작성자 | @kevin9327 |
| 원 source head | `6ba9e3d877` |
...
정합화했다. 표 셀 문단 서식 적용과 props 계약을 반영했다.
