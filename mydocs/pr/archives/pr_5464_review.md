# PR #5464 검토 - feat(render/pdf): #4764 페이지 격리 raster fidelity 잔여를 고정한다
...
- 원 PR: [5464](https://github.com/edwardkim/rhwp/pull/5464)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `0f5ee8617bf518eab6892ea419975347ee529c91`

## 체리픽 범위

- 통합 branch 체리픽 commit: `e0179a86d4d59ec6c7c8ab52eda9692fc032c289`
