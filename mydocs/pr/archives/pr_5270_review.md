...
# PR #5270 검토 - gym fuzz corpus 결정적 변형

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5270](https://github.com/edwardkim/rhwp/pull/5270) / kevin9327 |
| base / contributor head | devel / 955bcdd788e4d2fd2e1bb0a484286a8fc34c8d67 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | d3418a23f97debd7e98cacb32b30fda12629a3b5 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

fuzz corpus 변형과 예외 경로를 강화했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5270까지의 의존 순서를 따랐다.
...
- focused: scripts.tests.test_gym_fuzz_corpus
