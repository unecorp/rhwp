...
# PR #5369 검토 - 오라클 전수 스윕 러너

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5369](https://github.com/edwardkim/rhwp/pull/5369) / kevin9327 |
| base / contributor head | devel / 456a600b19c3df057637a3778069f03c30e4e8de |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | a6d2e55b64059e6d8eec88e9b9df0a775322bf5e |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

오라클 전수 스윕과 실패 상위 N 보고를 추가했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5369까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: tools/oracle_public/tests/__init__.py add/add는 테스트 패키지 표식을 유지했다.
- 보정: 새 manifest 기대값과 oracle fixture count를 정합화했다.
- 공통 통합 정리 commit: 5b9599ffb98c5dcc72c0e73937df076ea1e77031
- 공통 정합화 commit: 5f0d7e0a8482617747bdc7d7df57e98e6717a02c

## 검증

- focused: tools.oracle_public.tests.test_sweep_runner, tools.oracle_public.tests.test_oracle_resolver
