...
# PR #5004 검토 - edit insert-row 표 행 삽입

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5004](https://github.com/edwardkim/rhwp/pull/5004) |
| 작성자 | @kevin9327 |
| 원 source head | `9542a0e3b1c` |
...
정합화했다. 누적 스택에서 insert-row 고유 기능과 봉투 필드 계약을 반영했다.
