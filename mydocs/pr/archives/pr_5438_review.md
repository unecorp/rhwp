# PR #5438 검토 - test: WMF/EMF 골든 9종 + parse_wmf 시드 + 차트 OLE v1 경계 (M09x)
...
- 원 PR: [5438](https://github.com/edwardkim/rhwp/pull/5438)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `13586d2936cb61f52ddce42164ca134451047fe1`

## 체리픽 범위

- 통합 branch 체리픽 commit: `2fe184d077c48caa419628918d9cbea6bc3b25b3`
