# PR #5466 검토 - feat(oracle): M01-f 오라클 공개화 매니페스트·스윕 고도화
...
- 원 PR: [5466](https://github.com/edwardkim/rhwp/pull/5466)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `728c26e590e74254843736b8f13caa469709f469`

## 체리픽 범위

- 통합 branch 체리픽 commit: `b0f522ef691935e1701b4c0c3a5d791397e5cd82`
