# PR #5503 검토 - V-oracle: 한컴 정답지 vs 자기일관성 선택 트리
...
- 원 PR: [5503](https://github.com/edwardkim/rhwp/pull/5503)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `5bcc14bc473e2f6382c7e1deb8b8f5e09dd1d81c`

## 체리픽 범위

- 통합 branch 체리픽 commit: `c8bb09a6595b9bca21a105ac9c7d6454975ffa6d`
