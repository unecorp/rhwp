...
# PR #5050 검토 - edit insert-table 본문 표 생성

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5050](https://github.com/edwardkim/rhwp/pull/5050) |
| 작성자 | @kevin9327 |
| 원 source head | `1078fcb7a77` |
...
정합화했다. 본문 표 생성 CLI/MCP 배선과 rows·cols 계약을 현재 기준선에 반영했다.
