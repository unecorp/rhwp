...
# PR #5352 검토 - oracle_public issue_draft

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5352](https://github.com/edwardkim/rhwp/pull/5352) / kevin9327 |
| base / contributor head | devel / 98b248150d35db97818937be9f22e362210c1e3a |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 4f35648997ea6b5c7c641bd4e607639cfff1256c |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

임계 초과 문서의 issue 초안 생성 도구와 계약 시험을 추가했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5352까지의 의존 순서를 따랐다.

## 충돌 및 메인터너 보정

- conflict: 없음
- 보정: oracle fixture와 후속 manifest 정합화만 수행했다.
- 공통 통합 정리 commit: 5b9599ffb98c5dcc72c0e73937df076ea1e77031
- 공통 정합화 commit: 5f0d7e0a8482617747bdc7d7df57e98e6717a02c

## 검증

- focused: tools.oracle_public.test_issue_draft
