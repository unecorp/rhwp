# PR #5416 검토 - fix(hwpx): hwp3-sample16 HWPX 왕복 쪽수 64 유지 (#3518)
...
- 원 PR: [5416](https://github.com/edwardkim/rhwp/pull/5416)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `f025526c95ab74ad75396e6f91a80d2a26d2a88f`

## 체리픽 범위

- 통합 branch 체리픽 commit: `4d5b3be0db5b760ff8e9056f0ca2e9068aedeb71`
