# PR #5461 검토 - fix(hwpx): 연속 동일-id char_shapes 경계를 HWPX 왕복에서 보존한다 (#3500)
...
- 원 PR: [5461](https://github.com/edwardkim/rhwp/pull/5461)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `61ecdb87b4efe805709dd32d015eec944093c5ea`

## 체리픽 범위

- 통합 branch 체리픽 commit: `62ce7a3be5c2329bfacba027def38d028fd2c07c`
