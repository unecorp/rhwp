# PR #5423 검토 - feat(fuzz): equation 파서·svg export 타깃 추가 — M03-13
...
- 원 PR: [5423](https://github.com/edwardkim/rhwp/pull/5423)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `9b7888d671c6feaf6093c4944b9c8ee1d27aeaf0`

## 체리픽 범위

- 통합 branch 체리픽 commit: `df03309da0507b8fa3d582cc8d2969f83b865972`
