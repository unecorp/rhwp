...
# PR #5373 검토 - 페이지 수 왕복 공통 harness

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5373](https://github.com/edwardkim/rhwp/pull/5373) / kevin9327 |
| base / contributor head | devel / f73cb224a00d6c40c93eb3388d83fca7129ab065 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 535a2359562e04d64b13d14dd19e400f0794cc2e |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

페이지 수 왕복 검증에 재사용하는 공통 harness를 추가했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5373까지의 의존 순서를 따랐다.
...
- focused: tools.page_roundtrip.test_harness; Rust manifest/check 통과
