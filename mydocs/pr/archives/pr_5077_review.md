...
# PR #5077 검토 - edit split-paragraph-in-cell 표 셀 문단 분할

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5077](https://github.com/edwardkim/rhwp/pull/5077) |
| 작성자 | @kevin9327 |
| 원 source head | `34602ccb2b47` |
...
정합화했다. 표 셀 문단 분할 기능과 cellPara 계약을 반영했다.
