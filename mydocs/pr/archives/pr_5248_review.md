...
# PR #5248 검토 - gym release_diff 분류·보고

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5248](https://github.com/edwardkim/rhwp/pull/5248) / kevin9327 |
| base / contributor head | devel / 579b85d0b4e50df6929a958d5229820b24f21f88 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 75daa346d27ce0018beb143838110c0c576935f7, fafff7ce380ed670e3033628472713133523c1b0 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

release_diff 분류·예외 경로를 순수 함수와 정직성 시험으로 고정했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5248까지의 의존 순서를 따랐다.
...
- focused: scripts.tests.test_gym_release_diff
