...
# PR #5143 검토 - edit apply-char-format-in-cell 표 셀 글자 서식

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5143](https://github.com/edwardkim/rhwp/pull/5143) |
| 작성자 | @kevin9327 |
| 원 source head | `7767b212ab30` |
...
정합화했다. 표 셀 글자 범위 서식 적용과 전용 봉투 필드를 반영했다.
