...
# PR #5062 검토 - edit delete-text-in-cell 표 셀 문단 삭제

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5062](https://github.com/edwardkim/rhwp/pull/5062) |
| 작성자 | @kevin9327 |
| 원 source head | `315d0d427883` |
...
정합화했다. 표 셀 문단 삭제 기능과 삭제 좌표 계약을 반영했다.
