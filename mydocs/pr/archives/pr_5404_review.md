# PR #5404 검토 - docs: RenderBackend 어댑터 작성 가이드 (M06-5)
...
- 원 PR: [5404](https://github.com/edwardkim/rhwp/pull/5404)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `b84dca6b4e5638b2762b8090f70e2f5c1dfceb34`

## 체리픽 범위

- 통합 branch 체리픽 commit: `fc5e5f8034904d73b96afc0d8d4eed433e7d7eac`
