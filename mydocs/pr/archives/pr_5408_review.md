# PR #5408 검토 - fix(render): CanvasKit boxed-PUA·장평 폴백 해제 (M07-1)
...
- 원 PR: [5408](https://github.com/edwardkim/rhwp/pull/5408)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `1a11c1424f3ed29e7f147699667f1fb4cea72eda`

## 체리픽 범위

- 통합 branch 체리픽 commit: `a526d8a5fc750726e2e862813ec575e47d4684da`
