...
# PR #5007 검토 - edit merge-cells 표 셀 병합

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5007](https://github.com/edwardkim/rhwp/pull/5007) |
| 작성자 | @kevin9327 |
| 원 source head | `dee537fa22e` |
...
정합화했다. 누적 스택에서 merge-cells 고유 기능과 유효 범위 계약을 반영했다.
