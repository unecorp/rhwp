...
# PR #5120 검토 - edit split-cell-into 셀 n×m 분할

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5120](https://github.com/edwardkim/rhwp/pull/5120) |
| 작성자 | @kevin9327 |
| 원 source head | `3ab882f72c86` |
...
정합화했다. 셀 n×m 분할 기능과 행 높이·선행 병합 옵션을 반영했다.
