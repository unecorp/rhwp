...
# PR #5113 검토 - edit transpose-table 표 행·열 바꿈

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5113](https://github.com/edwardkim/rhwp/pull/5113) |
| 작성자 | @kevin9327 |
| 원 source head | `01097285de80` |
...
정합화했다. 병합 없는 본문 최상위 표의 행·열 바꿈 기능을 반영했다.
