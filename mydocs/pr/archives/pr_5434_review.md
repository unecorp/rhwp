# PR #5434 검토 - fix(hwpx): synam-001 HWPX 왕복 쪽수 35 유지 (#3521)
...
- 원 PR: [5434](https://github.com/edwardkim/rhwp/pull/5434)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `79c5859bd15735be7c2a60d808a2e3cd3792229a`

## 체리픽 범위

- 통합 branch 체리픽 commit: `47b91aaf6f67289c8e1ece5d6a863fd3849c19d1`
