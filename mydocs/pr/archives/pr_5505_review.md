# PR #5505 검토 - V-bon: dry-run/verify로 후보 N개 기계 순위
...
- 원 PR: [5505](https://github.com/edwardkim/rhwp/pull/5505)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `6f4cb306473cdbce1bcbb9579bb90671d012d6db`

## 체리픽 범위

- 통합 branch 체리픽 commit: `3ae435bbb721ccafc4b8456c983e73ca78b90a58`
