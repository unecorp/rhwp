# PR #5443 검토 - fix(render/pdf): svg2pdf SubsetError 를 페이지 단위로 격리한다 (#3773)
...
- 원 PR: [5443](https://github.com/edwardkim/rhwp/pull/5443)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `d48c46ac6228efe89d6731316e0968e1a2c49e7c`

## 체리픽 범위

- 통합 branch 체리픽 commit: `cf64b23318453b9b6c1d2829f77c1a937b37893a`
