# PR #5427 검토 - fix(render/pdf): bold ExtraLight 폴백을 제거해 PDF 굵기를 유지 (#3772)
...
- 원 PR: [5427](https://github.com/edwardkim/rhwp/pull/5427)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `8afcd137eca802e1f83fa204cc33252df266019f`

## 체리픽 범위

- 통합 branch 체리픽 commit: `6366d592901c6b2eafe6332c664e14bc7f587679`
