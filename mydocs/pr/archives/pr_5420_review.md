# PR #5420 검토 - refactor(equation): 수식 명령 디스패치 표준화 + 모듈 문서 (M09-2)
...
- 원 PR: [5420](https://github.com/edwardkim/rhwp/pull/5420)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `3cc751db59d396a311a5b532b18fa0c14645612d`

## 체리픽 범위

- 통합 branch 체리픽 commit: `f644e5ee15c444a3fefe1cc1a71302500652a937`
