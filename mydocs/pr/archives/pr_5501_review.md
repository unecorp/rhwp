# PR #5501 검토 - feat(v-proto): 검증기 입력은 종료코드·JSON 봉투만 (#5486)
...
- 원 PR: [5501](https://github.com/edwardkim/rhwp/pull/5501)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `7dc2556c8232026978b5a7815d988cdeb64d1c47`

## 체리픽 범위

- 통합 branch 체리픽 commit: `97cb48b650f5127bfd468d07a4696f9a07b7f3d9`
