...
# PR #5158 검토 - edit set-section-def 구역 정의

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5158](https://github.com/edwardkim/rhwp/pull/5158) |
| 작성자 | @kevin9327 |
| 원 source head | `7628e86dc1ac` |
...
정합화했다. 오래된 누적 branch가 기존 명령을 되돌리지 않도록 고유 기능만 수동 병합했고, 후속 계약·fmt 문서 보정을 순서대로 반영했다.
