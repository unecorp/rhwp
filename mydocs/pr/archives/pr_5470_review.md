# PR #5470 검토 - fix(hwpx): 정책연구 중간진도보고서 HWPX 왕복 쪽수 215 유지 (#4882)
...
- 원 PR: [5470](https://github.com/edwardkim/rhwp/pull/5470)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `2cd087a49d90026a46af67467f3744d70d547236`

## 체리픽 범위

- 통합 branch 체리픽 commit: `5b2ee734ca4e0ebd9e3094596568e01d46642cf5`
