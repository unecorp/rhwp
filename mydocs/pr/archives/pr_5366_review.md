...
# PR #5366 검토 - fuzz nightly smoke CI

## 접수 메타데이터

| 항목 | 검토 시점 참고값 |
| --- | --- |
| PR / 작성자 | [#5366](https://github.com/edwardkim/rhwp/pull/5366) / kevin9327 |
| base / contributor head | devel / b3245c7d9b637e1e88e1197307dd66ebe5749b91 |
| 가시성 branch | review/kevin9327-20260818-r1 |
| local cherry-pick | 39c11deca5a05cdaa89689269eeb851a9090de03 |
| 원격 상태 | OPEN, 비 draft, MERGEABLE, BLOCKED |
| 검토 기준 | upstream/devel 0bc05ef81 이후 누적 branch |

## 변경 범위

기존 6개 fuzz target을 nightly smoke와 crash artifact로 연결했다.

PR 고유 diff는 upstream/devel...review/kevin9327-20260818-r1 기준으로 확인했고, contributor
commit은 rewrite하지 않았다. 체리픽 순서는 5210부터 5366까지의 의존 순서를 따랐다.
...
- focused: git diff --check; Python 전체 1737 tests 통과. nightly runner는 원격 workflow에서 확인 필요.
