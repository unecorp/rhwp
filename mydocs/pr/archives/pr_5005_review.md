...
# PR #5005 검토 - edit insert-col 표 열 삽입

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5005](https://github.com/edwardkim/rhwp/pull/5005) |
| 작성자 | @kevin9327 |
| 원 source head | `fac191f61a3` |
...
정합화했다. 누적 스택에서 insert-col 고유 기능과 봉투 필드 계약을 반영했다.
