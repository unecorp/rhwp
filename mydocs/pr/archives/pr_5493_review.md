# PR #5493 검토 - feat(work-receipt): M-rcpt 작업 영수증·감사·계보 픽스처 고도화
...
- 원 PR: [5493](https://github.com/edwardkim/rhwp/pull/5493)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `01bc01fdfd57b48c02bcb60482c7e80e7f0115c1`

## 체리픽 범위

- 통합 branch 체리픽 commit: `8fce2898dad69f72752a4001424024a832cb825a`
