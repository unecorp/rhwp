# PR #5477 검토 - feat(fidelity): M-fid 텍스트층 소실·과잉·치환 표와 --text-only 픽스처
...
- 원 PR: [5477](https://github.com/edwardkim/rhwp/pull/5477)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `6d8377535ae395750385ea71423aa041f62c1359`

## 체리픽 범위

- 통합 branch 체리픽 commit: `7398569448a7c142fdadc20abf10422d98a33b34`
