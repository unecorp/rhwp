...
# PR #5646 검토: #5590 행별 선언 열 구획 보존

PR: [#5646](https://github.com/edwardkim/rhwp/pull/5646)  
원본 head: `98e929188dab898990cff72eb311631f09bfba15`  
...
- `issue_5590_per_row_column_widths`를 포함한 통합 후보의 전체 `release-test` 회귀는 7,869건 통과했다.
...
이 trailing 문서 commit의 fast-pass CI와 mergeability를 확인한 뒤 #5669를 병합한다. 병합 후 원 PR #5646에 통합 사실과 검증 결과를 댓글로 남기고 close하며, 원격 head 브랜치를 정리한다.
