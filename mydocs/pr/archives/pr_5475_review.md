# PR #5475 검토 - test(layout-anomaly): 판정 픽스처·verdict 행렬·성적표 고도화 (M02-f)
...
- 원 PR: [5475](https://github.com/edwardkim/rhwp/pull/5475)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `edadfc960c665c9d743fb53d654900530818c172`

## 체리픽 범위

- 통합 branch 체리픽 commit: `284d3d73686e7da5152e434bee22d41d294a140c`
