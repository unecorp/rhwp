# PR #5498 검토 - fix(hwpx): 한글 스펙문서 HWPX 왕복 쪽수 69 유지 (#5128)
...
- 원 PR: [5498](https://github.com/edwardkim/rhwp/pull/5498)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `1a7eeea074eee7046cd4944c2f2cfed2f6f0618f`

## 체리픽 범위

- 통합 branch 체리픽 commit: `d746f73fd373ea9715cad25b75713310de5f8484`
