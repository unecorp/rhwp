# PR #5406 검토 - feat(tools): samples/ layout-anomaly 전수 배치 리포트 (M02-8)
...
- 원 PR: [5406](https://github.com/edwardkim/rhwp/pull/5406)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `ee9d6771e87b99da0a154de6e3c9eb2486cd5603`

## 체리픽 범위

- 통합 branch 체리픽 commit: `221427569e22a04a123a17f186fd507b53e29e50`
