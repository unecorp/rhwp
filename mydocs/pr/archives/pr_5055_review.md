...
# PR #5055 검토 - edit insert-text-in-cell 표 셀 문단 삽입

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5055](https://github.com/edwardkim/rhwp/pull/5055) |
| 작성자 | @kevin9327 |
| 원 source head | `87047731bc93` |
...
정합화했다. 표 셀 문단 삽입과 cellPara 봉투 계약을 반영했다.
