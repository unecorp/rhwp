...
# PR #5310 검토 — agent: 서식 채우기(누름틀·메일머지) 스킬 고도화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5310](https://github.com/edwardkim/rhwp/pull/5310) / @kevin9327 |
| 원 head | `dcabeb4a4db7d5e47c0d131179fd9192b970084b` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `dcabeb4` → `7aa8303b` |
...
누름틀·메일머지 form-fill skill을 고도화한다. registry 충돌에서는 CAP-5293·5295·5296·5300을 함께 보존했고 신규 source를 cases 경로 규약에 맞게 배치했다. CAP-5300의 권위 문서 칸은 등록부의 단일 내부 Markdown 링크 규칙에 맞춰 서식 자동화 가이드 하나로 정규화했다.
