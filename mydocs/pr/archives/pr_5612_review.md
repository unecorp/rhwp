...
# PR #5612 검토: #5593 세로 가운데 셀의 비-flow 개체 높이 계상

PR: [#5612](https://github.com/edwardkim/rhwp/pull/5612)  
원본 head: `074e573cdfb6f54a3cb4ffd00f4b6259f8ede578`  
...
- `issue_5593_cell_center_front_object`를 포함한 통합 후보의 전체 `release-test` 회귀는 7,869건 통과했다.
...
이 trailing 문서 commit의 fast-pass CI와 mergeability를 확인한 뒤 #5669를 병합한다. 병합 후 원 PR #5612에 통합 사실과 검증 결과를 댓글로 남기고 close하며, 원격 head 브랜치를 정리한다.
