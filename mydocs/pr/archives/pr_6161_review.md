...
- 원본 PR: [#6161](https://github.com/edwardkim/rhwp/pull/6161)
...
Studio Canvas2D 표 셀 밑줄의 끝점을 괘선 안쪽으로 정리하고 브라우저 E2E를 추가했다.

## 검증과 증적

- 원본 current-head CI가 통과한 상태에서 반입했다.
- 통합 전체 regression: `8,417 passed`, Native Skia lib: 통과.
- 시각/실행 증적: [PR #6191 증적 인덱스](../assets/pr_6191/README.md)의 #6161 항목.
