# PR #5506 검토 - V-bind: 주장마다 search/extract-data 문서 좌표 강제
...
- 원 PR: [5506](https://github.com/edwardkim/rhwp/pull/5506)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `9a77f58bb12d0afc55f3933870619b95eae44542`

## 체리픽 범위

- 통합 branch 체리픽 commit: `c558f47b946391ad3d49de9139969699005e1b2e`
