# PR #5494 검토 - docs(prov): 출처 표지 지도·주입 경계 고도화
...
- 원 PR: [5494](https://github.com/edwardkim/rhwp/pull/5494)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `89bc9c0459b33f9993898004d6bcc8d0ebbe6bcd`

## 체리픽 범위

- 통합 branch 체리픽 commit: `5b9213a1667f92ccee5e62370a6d4f6f03e0ccb1`
