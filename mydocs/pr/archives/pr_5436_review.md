# PR #5436 검토 - fix(render): CanvasKit rotatedText char-overlap 폴백 해제 (M07-4)
...
- 원 PR: [5436](https://github.com/edwardkim/rhwp/pull/5436)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `44150cdf6d106a694abb60051095702e873b2774`

## 체리픽 범위

- 통합 branch 체리픽 commit: `48c67aed966355fc841505036179b74d405c1d0d`
