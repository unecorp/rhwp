...
# PR #5105 검토 - edit apply-cell-style 표 셀 문단 스타일

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5105](https://github.com/edwardkim/rhwp/pull/5105) |
| 작성자 | @kevin9327 |
| 원 source head | `f107ffbd9145` |
...
정합화했다. 표 셀 문단 스타일 적용 기능과 계약을 반영했다.
