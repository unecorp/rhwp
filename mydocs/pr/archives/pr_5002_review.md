...
# PR #5002 검토 - word-count 및 문단 편집 명령 축

## 접수

| 항목 | 기록 |
| --- | --- |
| PR | [#5002](https://github.com/edwardkim/rhwp/pull/5002) |
| 작성자 | @kevin9327 |
| 원 source head | `08e02248141e` |
...
정합화했다. 누적 PR의 insert-text·insert-paragraph·insert-page-break·word-count 범위를 현재 devel 기준으로 정합화했다.
