...
# PR #5651 검토: #5599 한컴 PUA 문자 대체

PR: [#5651](https://github.com/edwardkim/rhwp/pull/5651)  
원본 head: `df9d115442cdf6e2f79670ed445c802e4d0c10df`  
...
- `issue_5599_hancom_pua_display`를 포함한 통합 후보의 전체 `release-test` 회귀는 7,869건 통과했다.
...
이 trailing 문서 commit의 fast-pass CI와 mergeability를 확인한 뒤 #5669를 병합한다. 병합 후 원 PR #5651에 통합 사실과 검증 결과를 댓글로 남기고 close하며, 원격 head 브랜치를 정리한다.
