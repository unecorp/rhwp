# PR #5409 검토 - fix(parser/hwpx): HWPX 섹션 파서 재귀 깊이 가드 — 기본 스택 DoS (#4730)
...
- 원 PR: [5409](https://github.com/edwardkim/rhwp/pull/5409)
- 작성자: `kevin9327`
- base: `devel`
- 문서 작성 시점 상태: `OPEN`
- 원 PR head: `a5a2d16fbbc413637ba63136b4d89619710e3ae3`

## 체리픽 범위

- 통합 branch 체리픽 commit: `6f92b72a99d38495dc0a9af97ecaad90c112fbd3`
