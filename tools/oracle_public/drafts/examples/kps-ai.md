---
title: "[오라클] kps-ai: pdf_pages 77 (>= 12)"
labels: bug
draft: true
submit: never
---

# [오라클] kps-ai: pdf_pages 77 (>= 12)
...
문서 `samples/kps-ai.hwp` 가 한컴 기준 대비 임계 게이트를 넘었습니다.
...
```
python tools/oracle_public/page_smoke.py --pair samples/kps-ai.hwp pdf/kps-ai-2022.pdf
```
...
한컴 기준 PDF `pdf/kps-ai-2022.pdf` 와 같은 쪽수·레이아웃이어야 합니다.
