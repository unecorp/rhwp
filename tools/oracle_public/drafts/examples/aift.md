...
문서 `samples/aift.hwp` 가 한컴 기준 대비 임계 게이트를 넘었습니다.
...
```
python tools/oracle_public/page_smoke.py --pair samples/aift.hwp pdf/aift-2022.pdf
```
...
한컴 기준 PDF `pdf/aift-2022.pdf` 와 같은 쪽수·레이아웃이어야 합니다.
